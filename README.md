# Olá, eu sou o Messias Nunes Balieiro! 👋

Sou estudante de **Análise e Desenvolvimento de Sistemas** na **Fatec de Carapicuíba**, apaixonado por tecnologia, desenvolvimento de software e por resolver problemas reais através do código. 

---

### 🚀 Sobre Mim
- 🎓 Atualmente cursando o Ensino Superior de Tecnólogo em ADS (Previsão de conclusão: Dezembro de 2026).
- 🏫 Técnico em Desenvolvimento de Sistemas formado pela Etec de Carapicuíba.
- 🌐 Fluência em **Inglês Avançado**, **Espanhol Intermediário** e arranhando no **Francês Básico**.
- 🐱‍👤 Nas horas vagas, sou fã de coisas nerds e, claro, apaixonado por gatos!
...
| **Web & Mobile** | React.js, Node.js, HTML, CSS, Flutter  |
| **Ferramentas** | Excel, PowerBI, Linux, Powerpoint, Word  |
...
- 📧 **E-mail:** messiasnunesb@gmail.com 
- 💼 **LinkedIn:** (https://www.linkedin.com/in/messias-nunes-balieiro) 
